...
# После установки автоматически запустится postinstall скрипт
# который установит Electron и FFmpeg бинари
...
**Важно**: При первой установке pnpm может показать предупреждение об игнорировании build scripts. Это нормально - postinstall скрипт автоматически установит необходимые бинари.
